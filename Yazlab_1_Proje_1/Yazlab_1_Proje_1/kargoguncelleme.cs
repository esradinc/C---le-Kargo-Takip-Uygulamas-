...
{
    public partial class kargoguncelleme : Form
    {
        ...
        public kargoguncelleme()
        {
            InitializeComponent();
        }

        private void kargoguncelleme_Load(object sender, EventArgs e)
        {
        ...
        private async void guncellebutonu_Click(object sender, EventArgs e)
        {
            ...
            FirebaseResponse response = await client.UpdateAsync("kargolar/"+kargoidgir.Text , kargo);
            kargolar sonuc = response.ResultAs<kargolar>();
            MessageBox.Show("Güncellendi" + sonuc.KargoId);
